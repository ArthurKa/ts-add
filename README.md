[![All dependencies](https://img.shields.io/librariesio/release/npm/ts-add/1.1.0?style=flat-square "All dependencies of ts-add@1.1.0")](https://libraries.io/npm/ts-add/1.1.0)
